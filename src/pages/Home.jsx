          ...
          <Fade bottom delay={1100}>
            <div className="button-contain" style={{ marginTop: "22px" }}>
              <button className="main-button">
                <Link to="/voicewise/resources">Get started</Link>
              </button>
              <button className="sec-button">
                <a
                  href="https://discord.gg/AZvbb9sr3Y"
                  target="_blank"
        ...
        <section>
          <div className="head-text-contain">
            ...
            <p>
              ...
              mindset-building resources to succeed. We’re here to fill that
              gap.
            </p>
          </div>
        ...
        <section style={{ margin: "0" }} className="pillars">
          <div className="two-column-contain">
            <div className="head-text-contain">
              ...
              <p>
                Balance is key. We’ve highlighted sections of life that have
                been consistently repeated as the most important reasons for
          ...
          <div className="two-column-contain">
            ...
            <div className="column-text-contain">
              ...
              <div className="right-contain">
                ...
                <p>
                  A variety of resources for every kind of learner, divided
                  based on the type, length, and topic.
                </p>
              </div>
            </div>
          </div>
