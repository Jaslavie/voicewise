  ...
  return (
    <>
      <section>
        ...
        <div className="resource-column-contain">
          <div className="left-resource-contain">
            ...
            <h1>{h1}</h1>
            <p>{p}</p>
            <Numbers readTime={readTime} price={price} pageCount={pageCount} />
              ...
              <div className="sneak-peak-wrapper">
                {resourcesData[id]?.sneakItems.map((sneakItem, index) => {
                  const sneakInfo = SneakData.find(
                    (sneak) => sneak.iconNameSneak === sneakItem.iconNameSneak,
                  );
                  return (
                    <SneakPeak
                      key={index}
        ...
        <div className="drop-down">
          {resourcesData[id]?.dropItems.map((dropItems, index) => {
              return (
                <Dropdown
                  key={index}
                  dropDownTitle={dropItems.dropDownTitle}
                  dropDownDescription={dropItems.dropDownDescription}
                  expandedText = {dropItems.expandedText}
                />
              );
            })}
        </div>
